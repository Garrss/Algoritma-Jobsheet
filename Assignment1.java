...
public class Assignment1 {
    ...
    static double averageScoreBF(Assignment1[] students) {
        double totalScore = 0;
    ...
    static double averageScoreDC(Assignment1[] students, int start, int end) {
        if (start == end) {
    ...
    public static void main(String[] args) {
        ...
        Assignment1[] students = new Assignment1[numStudents];

        for (int i = 0; i < students.length; i++) {
            students[i] = new Assignment1();
